...
import { FiMail, FiLinkedin, FiGithub, FiDownload, FiSend, FiCheck } from 'react-icons/fi';
      ...
      <div className="container">
        ...
        >
          ...
          <p className="section-subtitle">
            Open to exciting opportunities, collaborations, and conversations about tech.
          </p>
        </motion.div>
          ...
          >
            <div>
              ...
              <p className="contact-info-text" style={{ marginTop: '16px' }}>
                I'm currently open to Frontend, Full-Stack Developer roles and freelance projects.
                Whether it's a startup idea, an open-source contribution, or just a tech chat — my inbox is always open.
              </p>
            </div>
            ...
            <div style={{
              ...
              <span style={{ color: 'var(--accent-emerald)', fontSize: '22px' }}>🟢</span>
              <div>
              ...
              {sent ? (
                ...
                <span style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                  <svg width="16" height="16" viewBox="0 0 16 16" style={{ animation: 'spin 1s linear infinite' }}>
                    <circle cx="8" cy="8" r="6" stroke="white" strokeWidth="2" fill="none" strokeDasharray="20" strokeDashoffset="5" />
                  </svg>
                  Sending...
                </span>
              ) : (
